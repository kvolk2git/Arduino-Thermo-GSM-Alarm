...
#define ModemResetPin 6 //Номер входа подключенного к делителю напряжения внешнего источника питания для проверки наличия внешнего питания. +5В-R1(2,2К)-.-R2(3,3K)-GND.
